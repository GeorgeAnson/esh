...
public class DetailUser extends User{
	...
	public String toString() {
		return "DetailUser [duAge=" + duAge + ", duGender=" + duGender + ", duMediHist=" + duMediHist + ", duAddress="
				+ duAddress + ", duEmerCall=" + duEmerCall + ", duProfession=" + duProfession + ", duAllergy="
				+ duAllergy + ", duHeight=" + duHeight + ", duWeight=" + duWeight + "]";
	}
}
